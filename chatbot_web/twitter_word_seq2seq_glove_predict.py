...
class TwitterWordGloveChatBot(object):
    model = None
    encoder_model = None
    decoder_model = None
    ...
    def __init__(self, type):
        ...
        self.model.load_weights('chatbot_train/models/' + DATA_SET_NAME + '/' + os.environ['CURRENT_TWITTER_MODEL'])
